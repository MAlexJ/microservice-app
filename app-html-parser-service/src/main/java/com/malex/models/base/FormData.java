...
public class FormData {
  ...
  /**
   * FORM_URLENCODED_DATA: "BillSearchModel.registrationNumber", "9672", //
   * "BillSearchModel.registrationNumberCompareOperation", "2", // "BillSearchModel.session", "10",
   * // "BillSearchModel.registrationRangeStart", "", // "BillSearchModel.registrationRangeEnd", "",
   * // "BillSearchModel.name", "", // "BillSearchModel.detailView", "false" //
   */
